            ...
            <div className="max-w-6xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="bg-gray-800/80 backdrop-blur-md p-6 rounded-xl shadow-xl mb-8 border border-gray-700">
                    <div className="flex flex-col md:flex-row gap-3">
                        ...
                        <button
                            type="submit"
                            className={`px-6 py-3 rounded-lg font-bold text-white transition-all duration-200 hover:scale-105 shadow-lg ${editingId ? "bg-blue-600 hover:bg-blue-700 shadow-blue-500/50" : "bg-green-600 hover:bg-green-700 shadow-green-500/50"
                                }`}
                        >
